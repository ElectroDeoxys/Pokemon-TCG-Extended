...
; Sprite animation IDs
	...
	const SPRITE_ANIM_CGB_AMY_LAYING        ; $28
	const SPRITE_ANIM_CGB_AMY_STAND         ; $29
	const SPRITE_ANIM_CGB_CLERK_NPC_UP      ; $2a
	const SPRITE_ANIM_CGB_CLERK_NPC_RIGHT   ; $2b
	const SPRITE_ANIM_CGB_CLERK_NPC_DOWN    ; $2c
	const SPRITE_ANIM_CGB_CLERK_NPC_LEFT    ; $2d
	const SPRITE_ANIM_CGB_VOLCANO_SMOKE     ; $2e
	const SPRITE_ANIM_CGB_OWMAP_CURSOR      ; $2f
	const SPRITE_ANIM_CGB_OWMAP_CURSOR_FAST ; $30
	const SPRITE_ANIM_TORCH                 ; $31
	const SPRITE_ANIM_CGB_CARD_TOP_LEFT     ; $32
	const SPRITE_ANIM_CGB_CARD_TOP_RIGHT    ; $33
	const SPRITE_ANIM_CGB_CARD_LEFT_SPARK   ; $34
	const SPRITE_ANIM_CGB_CARD_BOTTOM_LEFT  ; $35
	const SPRITE_ANIM_CGB_CARD_BOTTOM_RIGHT ; $36
	const SPRITE_ANIM_CGB_CARD_RIGHT_SPARK  ; $37
