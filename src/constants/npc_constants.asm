...
RSRESET
DEF NPC_DATA_ID              RB
DEF NPC_DATA_SPRITE_ID       RB
DEF NPC_DATA_ANIM            RB
DEF NPC_DATA_FLAGS           RB
DEF NPC_DATA_SCRIPT_BANK     RB
DEF NPC_DATA_SCRIPT_PTR      RW
DEF NPC_DATA_NAME_TEXT       RW
DEF NPC_DATA_DUELIST_PICTURE RB
DEF NPC_DATA_DECK_ID         RB
DEF NPC_DATA_DUEL_THEME_ID   RB
DEF NPC_DATA_MATCH_START_ID  RB
DEF NPC_DATA_LENGTH EQU _RS
