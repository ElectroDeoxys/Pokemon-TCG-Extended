...
Script_MeetAmy:
	...
	close_text_box
	set_sprite_attributes SPRITE_ANIM_AMY_STAND, NPC_FLAG_DIRECTIONLESS
	do_frames 32
	set_sprite_attributes SPRITE_ANIM_BLUE_NPC_UP, $00
...
.ows_e34e
	set_sprite_attributes SPRITE_ANIM_AMY_LAYING, NPC_FLAG_DIRECTIONLESS
