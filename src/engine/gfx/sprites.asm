...
Sprites:
	...
	gfx_pointer DuelBenchManipulationGfx, $0c ; SPRITE_DUEL_BENCH_MANIPULATION
	gfx_pointer DuelBigLightningGfx,      $2e ; SPRITE_DUEL_BIG_LIGHTNING
	gfx_pointer DuelBigSnoreGfx,          $46 ; SPRITE_DUEL_BIG_SNORE
	gfx_pointer DuelBone2Gfx,             $0c ; SPRITE_DUEL_BONE2
	gfx_pointer DuelBoneHeadbuttGfx,      $16 ; SPRITE_DUEL_BONE_HEADBUTT
	...
	gfx_pointer DuelCatPawGfx,            $11 ; SPRITE_DUEL_CAT_PAW
	gfx_pointer DuelCoinHurlGfx,          $12 ; SPRITE_DUEL_COIN_HURL
	...
	gfx_pointer DuelDarkSongGfx,          $08 ; SPRITE_DUEL_DARK_SONG
	gfx_pointer DuelDrainGfx,             $02 ; SPRITE_DUEL_DRAIN
	gfx_pointer DuelDrillDiveGfx,         $10 ; SPRITE_DUEL_DRILL_DIVE
	gfx_pointer DuelDrillGfx,             $25 ; SPRITE_DUEL_DRILL
	gfx_pointer DuelExplosionGfx,         $09 ; SPRITE_DUEL_EXPLOSION
	gfx_pointer DuelFireballsGfx,         $2b ; SPRITE_DUEL_FIREBALLS
	...
	gfx_pointer DuelFocusBlastBenchGfx,   $0c ; SPRITE_DUEL_FOCUS_BLAST_BENCH
	gfx_pointer DuelFocusBlastGfx,        $17 ; SPRITE_DUEL_FOCUS_BLAST
	gfx_pointer DuelFollowMeGfx,          $26 ; SPRITE_DUEL_FOLLOW_ME
	gfx_pointer DuelGasGfx,               $07 ; SPRITE_DUEL_GAS
	gfx_pointer DuelGlowGfx,              $09 ; SPRITE_DUEL_GLOW
	gfx_pointer DuelGooGfx,               $1a ; SPRITE_DUEL_GOO
	gfx_pointer DuelGuillotineGfx,        $48 ; SPRITE_DUEL_GUILLOTINE
	...
	gfx_pointer DuelIcePunchGfx,          $0f ; SPRITE_DUEL_ICE_PUNCH
	gfx_pointer DuelKickGfx,              $5e ; SPRITE_DUEL_KICK
	...
	gfx_pointer DuelMegaPunchGfx,         $2d ; SPRITE_DUEL_MEGA_PUNCH
	gfx_pointer DuelNeedlesGfx,           $08 ; SPRITE_DUEL_NEEDLES
	gfx_pointer DuelNineTailsGfx,         $48 ; SPRITE_DUEL_NINE_TAILS
	gfx_pointer DuelNoteGfx,              $08 ; SPRITE_DUEL_NOTE
	gfx_pointer DuelParalysisGfx,         $06 ; SPRITE_DUEL_PARALYSIS
	gfx_pointer DuelPerplexGfx,           $17 ; SPRITE_DUEL_PERPLEX
	...
	gfx_pointer DuelPsychicBeamBenchGfx,  $22 ; SPRITE_DUEL_PSYCHIC_BEAM_BENCH
	gfx_pointer DuelPsychicBeamGfx,       $31 ; SPRITE_DUEL_PSYCHIC_BEAM
	gfx_pointer DuelPsychicGfx,           $24 ; SPRITE_DUEL_PSYCHIC
	gfx_pointer DuelPsypunchGfx,          $2e ; SPRITE_DUEL_PSYPUNCH
	gfx_pointer DuelPunchGfx,             $1b ; SPRITE_DUEL_PUNCH
	gfx_pointer DuelQuestionMarkGfx,      $0a ; SPRITE_DUEL_QUESTION_MARK
	gfx_pointer DuelQuestionMarkSmallGfx, $07 ; SPRITE_DUEL_QUESTION_MARK_SMALL
	gfx_pointer DuelRazorLeafGfx,         $0c ; SPRITE_DUEL_RAZOR_LEAF
	gfx_pointer DuelResultGfx,            $36 ; SPRITE_DUEL_RESULT
	gfx_pointer DuelRockThrowGfx,         $18 ; SPRITE_DUEL_ROCK_THROW
	gfx_pointer DuelBoulderGfx,           $43 ; SPRITE_DUEL_BOULDER
	gfx_pointer DuelSkullBashGfx,         $3f ; SPRITE_DUEL_SKULL_BASH
	gfx_pointer DuelSkullGfx,             $1c ; SPRITE_DUEL_SKULL
	gfx_pointer DuelSlapGfx,              $34 ; SPRITE_DUEL_SLAP
	gfx_pointer DuelSlashGfx,             $0d ; SPRITE_DUEL_SLASH
	gfx_pointer DuelSleepGfx,             $08 ; SPRITE_DUEL_SLEEP
	gfx_pointer DuelSludgePunchGfx,       $31 ; SPRITE_DUEL_SLUDGE_PUNCH
	...
	gfx_pointer DuelSwiftGfx,             $0c ; SPRITE_DUEL_SWIFT
	gfx_pointer DuelTailSlapGfx,          $5a ; SPRITE_DUEL_TAIL_SLAP
	gfx_pointer DuelTailWhipGfx,          $3c ; SPRITE_DUEL_TAIL_WHIP
	gfx_pointer DuelTeleportGfx,          $32 ; SPRITE_DUEL_TELEPORT
	gfx_pointer DuelThunderGfx,           $0a ; SPRITE_DUEL_THUNDER
	gfx_pointer DuelVinePullGfx,          $08 ; SPRITE_DUEL_VINE_PULL
